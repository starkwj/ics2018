...
opcode_entry opcode_table [512] = {
  ...
  /* 0x40 */	IDEX(r, push), IDEX(r, push), IDEX(r, push), IDEX(r, push),
  /* 0x44 */	IDEX(r, push), IDEX(r, push), IDEX(r, push), IDEX(r, push),
  /* 0x48 */	IDEX(r, pop), IDEX(r, pop), IDEX(r, pop), IDEX(r, pop),
  /* 0x4c */	IDEX(r, pop), IDEX(r, pop), IDEX(r, pop), IDEX(r, pop),
